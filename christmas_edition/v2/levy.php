...
<html>
  ...
  <body>
      ...
      <div class="Halftext">
        <div class="font-effect-anaglyph">
          ...
          <h5 style="margin-top:50px; margin-bottom: 10px; width: 80%;">
            ...
            is FUCKING PROTECTED and IN THE FUCKING CHRISTMAS SPIRIT.</h5>
        ...
        <div>
          ...
          -->
          <p class="intro">IT'S FUCKING CHRISTMAS AGAIN.</p>
          <p class="intro">IF WE WORK TOGEHTER WE CAN MAKE IT THROUGH THIS.</p>
          <p class="intro">DO NOT ALLOW SANTA INTO YOUR HOME. HE CARRIES THE PLAGUE.</p>
          <p class="intro">STAY INSIDE. DON'T LET THE CHRISTMAS SPIRIT WEAKEN YOUR RESOLVE.</p>
          <hr width="80%" color="#FFFFFF" size="2" align="left" margin-bottom="-5px">
        </div>
    ...
    <div>
      ...
      <h5 margin-top="5px">Put Up a Song and BE JOLLY!</h5>
      ...
      <p>YOU'RE LOCKED IN: NO CHANGING THEMES ON CHRISTMAS. EVERYONE SUFFERS.</p>
       <h4 style="color: red;">The CHRISTMAS theme is: </h4>
      <form action="levy.php" method="post" autocomplete="off">
