...
<?php
  ...
  if (isset($_POST['user'], $_POST['pass'])){
    ...
    if (empty($user) or empty($pass)) {
      $error = 'The bouncer says "STOP FUCKING AROUND. GO DO CHRISTMAS SHIT."';
    } else {
      ...
      if ($user && password_verify($pass, $hashedpass)) {
        ...
        $error = 'The bouncer says "ONLY FOR THE HAPPY LEVYRAATI ELVES! EVERYONE ELSE FUCK OFF."';
...
<html>
  <head>
    <title>MERRY CHRISTMAS YOU FILTHY ANIMAL</title>
...
<!--CHRISTMAS THEME! -->
            ...
            <div class="font-effect-anaglyph">
              ...
              <h5 style="margin-top:50px; margin-bottom: 10px; color: red;">IT'S FUCKING CHRISTMAS AGAIN <br>EDITION</h5>
            </div>
            <div>
              ...
              <h5>STAY THE FUCK INSIDE. <br>RATE FUCKING CHRISTMAS SONGS. <br>REMAIN PURE AND PASS THE FUCK OUT.</h5>
...
<form action="index.php" method="post" autocomplete="off">
  <input type="text" name="user" placeholder="Tell Santa who you the fuck you are..."/>
  <br>
  <input type="password" name="pass" placeholder="Whisper your password to fucking Santa..."/>
  <br>
