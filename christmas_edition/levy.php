...
<html>
  ...
  <body>
      ...
      <div class="Halftext">
        <div class="font-effect-anaglyph">
          ...
          <h5 style="margin-top:50px; margin-bottom: 10px; width: 80%;">
            ...
            is PROTECTED and IN THE CHRISTMAS SPIRIT.</h5>
        ...
        <div>
          ...
          -->
          <p class="intro">Christmas is a time of peace and joy. YET WE MUST REMAIN VIGILANT.</p>
          <p class="intro">BE JOLLY AND HAPPY IN ISOLATION.</p>
          <p class="intro">DO NOT ALLOW SANTA INTO YOUR HOME TO SPREAD DISEASE.</p>
          <p class="intro">WE CAN ALL SURVIVE CHRISTMAS IF WE STAY RESOLUTE.</p>
          <hr width="80%" color="#FFFFFF" size="2" align="left" margin-bottom="-5px">
        </div>
    ...
    <div>
      ...
      <h5 margin-top="5px">Put Up a Song and ISOLATE!</h5>
      ...
      <div>
       ...
       <h4 style="color: red;">Your current theme</h4>
