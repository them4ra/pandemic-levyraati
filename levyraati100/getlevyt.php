	...
	public function get_banger($songid) {
     ...
     return $query->fetch();
		...
		public function get_top10_2021() {
			 ...
			 $query = $pdo->prepare("SELECT songby, songid, AVG(rating) FROM ratings WHERE thetime BETWEEN 1609452320 AND 1640901920 GROUP BY songid ORDER BY 3 DESC LIMIT 25;");
			 $query->bindValue(1, $wantedtime);
			 $query->execute();
		...
		public function martinratedwith10($wantedtime) {
			 ...
			 $query = $pdo->prepare("SELECT songby, songid, AVG(rating), COUNT(rating) FROM ratings WHERE thetime >= ? GROUP BY songid HAVING COUNT(rating) > 2 ORDER BY 3 ASC LIMIT 10;");
			 $query->bindValue(1, $wantedtime);
			 $query->execute();
		...
		public function get_bottom10_2021() {
			 ...
			 $query = $pdo->prepare("SELECT songby, songid, AVG(rating) FROM ratings WHERE thetime BETWEEN 1609452320 AND 1640901920 GROUP BY songid ORDER BY 3 ASC LIMIT 25;");
			 $query->bindValue(1, $wantedtime);
			 $query->execute();
