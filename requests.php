...
<html>
  ...
  <body>
    ...
    <?php
    $query = $pdo->prepare("SELECT * FROM requests ORDER BY commenttime DESC");
    ...
    ?>
      ...
      <p style="color: green;"><a href="requestsgiven.php">Show only Granted Requests</a></p>
      <p style="color: green;"><a href="requestsopen.php">Show All Open Requests</a></p>
      <p style="color: green;"><a href="requestswork.php">Show All Requests Being Worked On</a></p>
